...
public:
    ...
    void SetBindMatrix(std::vector<glm::mat4> BindMatrix);
    void SetOverallTransformation(std::vector<glm::mat4> OverallTransformation);
    void SetTimer(int timeCount);
