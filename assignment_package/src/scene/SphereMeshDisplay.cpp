#include "SphereMeshDisplay.h"
#include<la.h>
#include <iostream>

SphereMeshDisplay::SphereMeshDisplay(OpenGLContext *mp_context)
    : Drawable(mp_context)
{}
GLenum SphereMeshDisplay::drawMode() {
    return GL_LINES;
}
void SphereMeshDisplay::create() {
    float radius = 0.5f;
    int segments = 12;
...
glm::mat4 SphereMeshDisplay::getTransformationMatrix() {
    return this->transformationMatrix;
}
void SphereMeshDisplay::setTransformationMatrix(glm::mat4 jointTransform) {
